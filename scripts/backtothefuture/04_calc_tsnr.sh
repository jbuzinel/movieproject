...
export deriv_root=/nndb_teens/jure/MovieProject/bids_data/derivatives
...
# Zip outputs
find /nndb_teens/jure/MovieProject/bids_data/derivatives -type f \( -name "*.nii" -o -name "*.BRIK" \) -exec gzip -f "{}" \;
